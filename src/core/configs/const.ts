...
export default {
    ...
    BASE_URL_TEST: "https://dc70-115-42-33-161.in.ngrok.io/",
    BASE_URL_PROD: "https://dc70-115-42-33-161.in.ngrok.io/",
    THEME: {
        primary: "#062743",
        secondary: "#182952",
...
export const slides = [
    {
      key: "slide1",
      image: require("@core/assets/intro/frontal_home.png"),
    ...
    {
      key: "slide2",
      image: require("@core/assets/intro/doodle_reading.png"),
      title: "Read News",
      text:
    ...
    {
      key: "slide3",
      image: require("@core/assets/intro/stting_on_floor.png"),
